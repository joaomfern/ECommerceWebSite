...
namespace EcommerceProject.Migrations
{
    public partial class PedidoDetalhes : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade); //isto significa que os dados da tabela filha serão excluidos se forem apagados dados da tabela pai
                    table.ForeignKey(
                        name: "FK_PedidoDetalhes_Shirts_ShirtId",
                        column: x => x.ShirtId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PedidoDetalhes_ShirtId",
                table: "PedidoDetalhes",
                column: "ShirtId");
        }
